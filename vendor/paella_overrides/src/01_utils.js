...
// #DCE MATT-2429 error container overflow height override
// This file is being overridden just for line 550 to set min-height vs height
// This is a TEMPORARY override until next upgrade, latest paella moved errorContainer height to css
...
Class ("paella.MessageBox", {
	...
	doShowMessage:function(message,closeButton,width,height,className,onClose) {
		...
		messageContainer.className = className;
		messageContainer.style.width = width;
                //#DCE MATT-2429 change height to minHeight to contain error box overflow
                // TEMPORARY, later versions of Paella moved height to css
                // ref, https://github.com/polimediaupv/paella/pull/366
		messageContainer.style.minHeight = height;
		messageContainer.style.position = 'relative';
