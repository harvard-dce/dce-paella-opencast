...
class Caption {
	constructor(id, format, url, lang, next) {
		...
		// #DCE OPC-374 fix UPV Paella lunr 2x caption search
...
(function() {
	...
	class LoaderContainer extends paella.DomNode {
		...
		constructor(id) {
			super('div',id,{position:'fixed',backgroundColor:'white',opacity:'0.9',top:'0px',left:'0px',right:'0px',bottom:'0px',zIndex:10000});
			this.timer = null;
			this.loader = null;
