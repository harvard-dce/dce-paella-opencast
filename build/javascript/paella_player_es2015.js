...
class VideoContainerBase extends paella.DomNode {
	...
	playIfNonAreSeeking (player) {
		...
		base.log.debug(`HTML5: PLAY? playIfNonAreSeeking '${player.stream.content}' at '${player.video.currentTime}', seeking players: '${seekingCount}', waiting to player players: '${waitingForPlayCount}'.`);
